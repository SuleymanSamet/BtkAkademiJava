...
//methot overloading giris
    ...
    public void giris(String girisSaati,String cikisSaati){
        System.out.println(this.adSoyad+" "+girisSaati+" saatinde üniversiteye giriş yapacak ve "+cikisSaati+" çıkış yapacak");
    }
    //bu kısım da giris methoduna overloding yapıldı
